...
class HumanForm(forms.Form):
    ...
    education = forms.CharField(required=False,widget=forms.TextInput(attrs={"placeholder":"Enter your education"}))
    experience = forms.CharField(required=False,widget=forms.TextInput(attrs={"placeholder":"Enter your experience"}))
    ...
    foreign_languages = forms.CharField(required=False,widget=forms.TextInput(attrs={"placeholder":"Enter your foreign language"}))
...
class SearchBarForm(forms.Form):
    searchBar= forms.CharField(required=False,widget=forms.TextInput(attrs={"placeholder":"Search for Jobs"}))
    job_location = forms.ChoiceField(choices=[
    ('Unspecified','Select a location'),
    ('Adelaide', 'Adelaide'),
    ('Amsterdam', 'Amsterdam'),
...
class MiniSearchForm(forms.Form):
    searchBar= forms.CharField(widget=forms.TextInput(attrs={"placeholder":"Search for a user or company"}))
