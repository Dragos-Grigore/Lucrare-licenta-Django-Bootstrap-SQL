...
class User(models.Model):
    ...
    education = models.TextField(max_length=500, default='unspecified')  # Specify a default value
...
class Company(models.Model):
    ...
    phone_number = models.CharField(max_length=20, default='unspecified')  # Specify a default value
